...
@time @showprogress for K = 0.01: 0.05: 1.0, n = 1.0:0.2:2., δ = 10:5:500, A = 20., up = 1.:1.:10. 
    @show K, n, δ, A, up
    Δ0 = 20000.
    param = [K, n, δ, A, up]
    # solve DiffEq given parameters
...
CSV.write("3Bits_DB_new1.csv", df3) # 14543x3
CSV.write("3Bits_DB_new1_error.csv", df3_error) # 14543x3
