...
@time @showprogress for K = 0.011: 0.02:0.1, n = 7.1:0.1:8., δ = 250:5:350, A = 20., up = 1:0.1:3 # up resolution 0.1
    @show K, n, δ, A, up
    Δ0 = 20000.
    param = [K, n, δ, A, up]
    # solve DiffEq given parameters
...
##
df3
CSV.write("3Bits_DB_new3_2_16inch.csv", df3) # 14543x3
CSV.write("3Bits_DB_new3_2_16inch_error.csv", df3_error)
