...
using DifferentialEquations, ParameterizedFunctions,Plots;pyplot()
using Latexify
...
plot(sol,vars=[(0,6),(0,7)], xlabel = "time", ylabel = "concentration", dpi = 1000)
...
plot(sol2,vars=[(0,6),(0,7)], xlabel = "time", ylabel = "concentration", dpi = 1000)
